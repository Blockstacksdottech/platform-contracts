...
contract('EthicHubLoanRepayment', function([owner, borrower, investor, investor2, investor3, investor4, localNode, ethicHubTeam, community, arbiter]) {
    ...
    describe('Partial returning of funds', function() {
        ...
        it('partial payment of the loan should not allow to recover interest, local node and team fees', async function() {
            ...
            await this.repayment.reclaimEthicHubTeamFee().should.be.rejectedWith(EVMRevert)
        })
    })
